...
pp <- zzx %>% 
  ggplot() + 
  aes( x= name, fill = intervention ) + 
  geom_bar(stat = "count") +
       labs(title = "Interventions<BR> sur les trois consultations",
             y = "n"
             ) +
     theme_light() + 
  ...
  scale_x_discrete(breaks=c("ni_m4"  "ni_m12" "ni_m24"),
        labels=c("mois 4", "mois 12", "mois 24"))
